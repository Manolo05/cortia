...
const features = [
  { icon: '\u{1F9E0}', cls: 'bg-[#0B1D3A] text-[#D4A843]', title: 'Score de risque IA', desc: "Analyse automatique : endettement, reste \u00e0 vivre, stabilit\u00e9 des revenus. Score de 0 \u00e0 100." },
  { icon: '\u{1F3E6}', cls: 'bg-[rgba(212,168,67,0.15)] text-[#D4A843]', title: 'Recommandation bancaire', desc: "Croisement profil emprunteur et crit\u00e8res d'acceptation de chaque banque." },
  { icon: '\u{1F4C4}', cls: 'bg-[rgba(55,138,221,0.1)] text-[#378ADD]', title: 'OCR documents', desc: "Upload et extraction automatique des bulletins de salaire et avis d'imposition." },
  { icon: '\u{1F4CA}', cls: 'bg-[rgba(212,168,67,0.15)] text-[#D4A843]', title: 'Tableau de bord', desc: "Tous vos dossiers, statuts, relances et KPIs en un coup d'oeil." },
  { icon: '\u{1F4AC}', cls: 'bg-[#0B1D3A] text-[#D4A843]', title: 'Assistant IA', desc: "Posez vos questions : Ce dossier passe-t-il au Cr\u00e9dit Agricole ? Quels documents manquent ?" },
  { icon: '\u{1F512}', cls: 'bg-[rgba(55,138,221,0.1)] text-[#378ADD]', title: 'Conformit\u00e9 RGPD', desc: "Donn\u00e9es h\u00e9berg\u00e9es en France, conformit\u00e9 RGPD et AI Act." },
];
  ...
  return (
    <div className="bg-[#F7F4EE] text-[#0B1D3A] overflow-x-hidden" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
        ...
        <div className="max-w-[1200px] mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <button onClick={goApp} className="bg-[#0B1D3A] text-white px-8 py-4 rounded-[10px] text-[15px] font-semibold hover:bg-[#122A52] transition-all hover:-translate-y-0.5">D\u00e9marrer gratuitement \u2192</button>
          ...
          <div className="relative hidden md:block">
            ...
            <div className="bg-white rounded-[20px] p-7 shadow-[0_24px_80px_rgba(11,29,58,0.08)] border border-[rgba(11,29,58,0.04)]">
              ...
              <div className="grid grid-cols-3 gap-3 mb-5">
                ...
                <div className="bg-[#F7F4EE] rounded-[10px] p-3.5"><div className="text-[11px] text-[#8A97A8] uppercase tracking-wider mb-1">Montant</div><div className="text-[22px] font-bold text-[#378ADD]">285k\u20ac</div></div>
              </div>
      ...
      <section className="py-24"><div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-5 mt-16">{testimonials.map((t,i)=>(<Reveal key={i} style={{transitionDelay:`${i*100}ms`}}><div className="bg-white rounded-[20px] p-7 border border-[rgba(11,29,58,0.04)]"><div className="text-[#D4A843] text-sm tracking-widest mb-3">\u2605\u2605\u2605\u2605\u2605</div><p className="text-[15px] leading-[1.7] mb-5 italic">&ldquo;{t.text}&rdquo;</p><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-full bg-[#0B1D3A] flex items-center justify-center text-[#D4A843] font-bold text-sm">{t.initials}</div><div><div className="font-semibold text-sm">{t.name}</div><div className="text-xs text-[#8A97A8]">{t.role}</div></div></div></div></Reveal>))}</div>
      </div></section>
